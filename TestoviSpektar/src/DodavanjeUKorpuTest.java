...
public class DodavanjeUKorpuTest {
  ...
  Logger l = Logger.getLogger(DodavanjeUKorpuTest.class.getName());
  ...
  @Test
  public void DodavanjeUKorpuTest() throws InterruptedException {
	    ...
	    driver.findElement(By.cssSelector(".add-to-cart > span")).click();
	    driver.findElement(By.cssSelector(".cart__button-text")).click();
	    driver.close();
	  }
