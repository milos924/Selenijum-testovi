...
public class ValidnostTest {
  ...
  Logger l = Logger.getLogger(ValidnostTest.class.getName());
  ...
  @Test
  public void ValidnostTest() throws Exception {
	    ...
	    driver.findElement(By.cssSelector(".auth-page")).click();
	    driver.findElement(By.cssSelector(".auth-page")).click();
	    driver.findElement(By.cssSelector(".form-group")).click();
	    driver.findElement(By.cssSelector(".form__box")).click();
